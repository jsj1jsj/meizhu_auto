...
class OperateHeader(object):
    ...
    # 组装headers
    def headers_data(self, dataKey, tokenKey, fieldToken,appId):
        hotelCode = self.readCon.get_config_value('hotelInfo','hotelCode')
        # appId = readCon.get_config_value('hotelInfo','appId')
    ...
    def save_token(self, dataKey, tokenKey,fieldToken,appId):
        data = self.headers_data(dataKey,tokenKey,fieldToken,appId)
