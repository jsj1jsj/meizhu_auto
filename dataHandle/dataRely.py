...
class DataRely(object):
    ...
    def get_init_rely_data(self, start=0, end=1):
        ...
        QNcheckInDate = self.ed.get_target_date6(start)
        QNcheckOutDate = self.ed.get_target_date6(end)
        ...
        xcxhotelCode = self.readCon.get_config_value('xiaochengxuOrder', 'xcxhotelCode')
        ...
        doublePrice = self.readCon.get_config_value('hotelInfo', 'doublePrice')
        fourPrice = self.readCon.get_config_value('hotelInfo', 'fourPrice')
        nonRoomTypeCode = self.readCon.get_config_value('hotelInfo', 'nonRoomTypeCode')
        opIp = self.readCon.get_config_value('opOrder', 'opIp')
        opOrderId = self.readCon.get_config_value('opOrder', 'opOrderId')
        ophotelCode = self.readCon.get_config_value('opOrder', 'ophotelCode')
        opsalePrice = self.readCon.get_config_value('opOrder', 'opsalePrice')
        ...
        relyData = {
            ...
            'fourPrice': fourPrice,
            'nonRoomTypeCode': nonRoomTypeCode,
            'twoBeforeDate': twoBeforeDate,
            'twoBeforeTime': twoBeforeTime,
            'opIp': opIp,
            'opOrderId': opOrderId,
            'ophotelCode': ophotelCode,
            'opsalePrice': opsalePrice,
            'opL1Price': opL1Price,
            'opL2Price': opL2Price,
            'opL3Price': opL3Price,
            'opL4Price': opL4Price,
